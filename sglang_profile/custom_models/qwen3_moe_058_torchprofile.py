...
class Qwen3MoeAttention(nn.Module):
    ...
    def forward_core(self, intermediate_state):
        ...
        with record_function(f"component_range:attention_core_attention_layer{self.layer_id}"):
        ...
        with record_function(f"component_range:attention_core_output_proj_layer{self.layer_id}"):
...
class Qwen3MoeForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        print("Initialized Qwen3MoeForCausalLM with torch profile record_functions")
