...
export MODEL_PATH="/nfs/xjzhang/Qwen3-30B-A3B-1layer"
...
BS="1 2 1 2 4 8 16 32 40 64 128 256 512 1024 2048 4096 8192"
IL=1600
OL=4
...
for i in "${!NODES[@]}"; do
    ...
    export SGLANG_TORCH_PROFILER_DIR="$PWD/profile_log/profile_${MODEL_NAME}_il${IL}_memory${MEMORY_FRACTION_STATIC}_${DATE}"
    ...
    python bench_one_batch_058.py \
        ...
        --mem-fraction-static $MEMORY_FRACTION_STATIC > logs/bench_${MODEL_NAME}_il${IL}_memory${MEMORY_FRACTION_STATIC}_dp${DP}_ep${EP}_tp${TP}_${DATA_SOURCE}_${DATE}.log 2>&1
