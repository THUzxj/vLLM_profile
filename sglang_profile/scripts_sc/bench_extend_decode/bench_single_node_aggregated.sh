...
CACHED_TOKEN_LENS=${CACHED_TOKEN_LENS:-"1000 2000 4000 8000 16000 32000"}
OUTPUT_LEN=${OUTPUT_LEN:-"148"}
EXTEND_LEN=${EXTEND_LEN:-"608"}
...
for CACHED_LEN in $CACHED_TOKEN_LENS; do
    ...
    python bench_one_batch_server_058.py \
        ...
        --result-filename "$RESULT_DIR/results_cached${CACHED_LEN}.jsonl" \
        --measure \
        --enable-dp-attention \
        --dp 2 \
        2>&1 | tee "$RESULT_DIR/benchmark_cached${CACHED_LEN}.log"
