...
RESULT_DIR="results_v2/sglang_Qwen3-235B-A22B_1layer_new2_il512_bs64"
...
nsys profile --trace-fork-before-exec=true --cuda-graph-trace=node -o "$RESULT_DIR/nvtx_events" \
