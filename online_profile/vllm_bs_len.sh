...
model_id=/nfs/xjzhang/Qwen/Qwen3-4B/
model_name=Qwen3-4B
...
for iter in 1 2 3 4 5; do
    ...
    for input_len in 512 1024 2048 4096 8192 16384; do
        for batch_size in 1 2 4 8 16 32 64 128 256; do
            ...
            RESULT_DIR="bs_len_test_model${model_name}_mps${MPS_SIZE}_2/benchmark_results_20251130_serving_0_11_2_mps_${MPS_SIZE}_iter${iter}"
