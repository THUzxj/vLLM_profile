...
SCRIPT_NAME="test_qwen3_decoder_layer_parallel.py"

MODEL_SIZE="32B"
MIN_COUNT=52
ID="_2"

OUTPUT_DIR="sweep_results_layers"
...
TOTAL_COMBINATIONS=$((${#BATCH_SIZES[@]} * ${#SEQ_LENS[@]} * ${#NUM_GROUPS[@]}))
...
for batch_size in "${BATCH_SIZES[@]}"; do
    for seq_len in "${SEQ_LENS[@]}"; do
        for num_groups in "${NUM_GROUPS[@]}"; do
            ...
            echo "  batch_size=$batch_size, seq_len=$seq_len, num_groups=$num_groups"
